...
def mpiAcuerdos(Mpi,response_idCaso,r_User):
  ...
  print ("Response status code:", r_AcInicio.status_code)
  print ("Response content:", r_AcInicio.content)
  Mpi.wait()
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idAcInicio + "/F1_007", name="Acuerdo de Inicio: Peticion para Generar el Oficio Caratula Acuerdo General")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  

  if response.status_code == 500 :
    f = open('error.txt', 'a')
    f.write('\n' + 'Oficio Caratula Acuerdo General: \n' + 'Response status code: \n' + str(response.status_code) + 
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idAcInicio + "/F1_015_016", name="Acuerdo de Inicio: Peticion para Generar el Oficio Acuerdo de Inicio")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  

  if response.status_code == 500 :
    f = open('error.txt', 'a')
    f.write('\n' + 'Oficio Acuerdo de inicio: \n' + 'Response status code: \n' + str(response.status_code) + 
      '\n' + 'Response content: \n' + str(response.content))
    f.close()
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idAcInicio + "/F2_117", name="Acuerdo de Inicio: Peticion para Generar el Oficio Registro de Derivación a la Justicia Restaurativa del Caso")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  

  if response.status_code == 500 :
    f = open('error.txt', 'a')
    f.write('\n' + 'Oficio Registro de Derivación a la Justicia Restaurativa: \n' + 'Response status code: \n' + str(response.status_code) + 
      '\n' + 'Response content: \n' + str(response.content))
    f.close()
  ...
  print ("Response status code:", r_AcRadic.status_code)
  print ("Response content:", r_AcRadic.content)
  Mpi.wait()
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + str(r_idAcRadic) + "/F2_138", name="Acuerdo de Radicación: Peticion para Generar el Oficio Acuerdo de recepción y/o radicación")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  

  if response.status_code == 500 :
    f = open('error.txt', 'a')
    f.write('\n' + 'Oficio Acuerdo de recepción y/o radicación: \n' + 'Response status code: \n' + str(response.status_code) + 
      '\n' + 'Response content: \n' + str(response.content))
    f.close()
...
def mpiEntrevistas(Mpi,response_idCaso):
  ...
  print ("Response status code:", r_Entrev.status_code)
  print ("Response content:", r_Entrev.content)
  Mpi.wait()
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idEntrev + "/F1_008", name="Entrevistas: Peticion para Generar el Oficio Entrevista")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
