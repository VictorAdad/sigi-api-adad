...
def mpiSolicitudesPreliminares(Mpi,response_idCaso):
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/"+formatoPoliciaInvestId+"/F1_011", name="ERROR DOC - ERROR DOC - Policias de Investigacion Formato 1")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/"+formatoPoliciaInvestId+"/F1_021", name="ERROR DOC - Policias de Investigacion Formato 2")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolPer + "/F1_009", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Solicitud a Servicios Periciales")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolPsic + "/F1_010", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Solicitud Examen Psicofísico")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolAcuAAJ + "/F1_002", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Solicitud de asesor jurídico")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolAcuAAV + "/F1_001", name="ERROR DOC -  Solicitudes: Peticion para Generar el Oficio de ayuda a atencion a la victima")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolRegGralAG + "/F1_006", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Acuerdo General del Caso")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
...
#################################################################################################################################################
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolRegGraLlamada + "/F2_063", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Registro de llamada para permitir al imputado comunicarse con su defensor del Caso")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content) 
...
########################################################################################
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolRegGral + "/F1_017", name=" ERROR DOC - Solicitudes: Peticion para Generar el Oficio Registro General")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
...
########################################################################################
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolInsp + "/F1_018", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Inspección General")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
...
########################################################################################
  ...
  response = Mpi.client.get("/v1/documentos/formatos/save/" + r_idSolReqInf + "/F2_039", name="ERROR DOC - Solicitudes: Peticion para Generar el Oficio Solicitud de requerimiento de información")
  print ("Response status code:", response.status_code)
  print ("Response content:", response.content)  
