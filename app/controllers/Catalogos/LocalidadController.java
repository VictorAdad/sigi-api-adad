...
public class LocalidadController extends BaseController {
    ...
    @Inject
    public LocalidadController(FormFactory formFactory,
    ...
    ****************************************************************/
    ...
    public CompletionStage<Result> optionsByMunicipio(Long id) {
    ...
    @Cached(key = "LocalidadController.list", duration = (60*60) * 2 )
    ...
    public CompletionStage<Result> save() throws PersistenceException {
      return super.save(new String [] {"LocalidadController.list"});
    }

    public CompletionStage<Result> update(Long id) throws PersistenceException {
      return super.update(id, new String [] {"LocalidadController.list"});
    }
}
