...
import play.cache.Cached;
  ...
  * del Modelo y el repositorio de Pais que es y forma parte
...
public class PaisController extends BaseController {
    ...
    ****************************************************************/
     ...
     * para un elemento select en formato de Json de un Modelo de Pais.
     *
     * @author Oscar Gibrán Córdoba Méndez
     *
     *
     * @return      Json de Pais actualizado
     * @see         models.Pais
     *
     * @version 1.0
     *
     * @since 1.0
     */
    @Cached(key = "PaisController.options", duration = (60*60) * 2 )
    ...
    public CompletionStage<Result> save() throws PersistenceException {
      return super.save(new String [] {"PaisController.options"});
    }

    public CompletionStage<Result> update(Long id) throws PersistenceException {
      return super.update(id, new String [] {"PaisController.options"});
    }
}
