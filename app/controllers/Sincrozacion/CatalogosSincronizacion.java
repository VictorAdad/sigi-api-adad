...
import repository.CatalogoSincronizacionRepository;

 /**
  * Esta clase es un controlador para manipular las acciones
  * del Modelo y el repositorio de CatalogoSincronizacion que es y forma parte
...
public class CatalogosSincronizacion extends BaseController {

    private AsyncCacheApi cache;

    @Inject
    public CatalogosSincronizacion(FormFactory formFactory,
                CatalogoSincronizacionRepository repository,
