...
import play.mvc.With;
  ...
  * del Modelo y el repositorio de Lugar que es y forma parte
...
public class Lugares extends CaseCatalogBaseController {
    ...
    ****************************************************************/
    ...
    /**
     * Metodo que retorna la actualizacion de un Modelo de Lugar.
     *
     * @author Oscar Gibrán Córdoba Méndez
     *
     * @param  id   id de lugar
     *
     * @return      Json de Lugar actualizado
     * @see         models.Lugar
     *
     * @version 1.0
     *
