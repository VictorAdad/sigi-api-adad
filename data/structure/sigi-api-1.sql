...
create table predenuncia (
  ...
  hora_conclusion_llamada       timestamp,
...
create table titulares (
  ...
  caso_id                       number(19),
  propietario_id                number(19),
  asignado_id                   number(19),
  asignacion_id                 number(19),
  created                       timestamp not null,
  updated                       timestamp not null,
...
alter table titulares add constraint fk_titulares_propietario_id foreign key (propietario_id) references usuario (id);
create index ix_titulares_propietario_id on titulares (propietario_id);

alter table titulares add constraint fk_titulares_asignado_id foreign key (asignado_id) references usuario (id);
create index ix_titulares_asignado_id on titulares (asignado_id);

alter table titulares add constraint fk_titulares_asignacion_id foreign key (asignacion_id) references usuario (id);
create index ix_titulares_asignacion_id on titulares (asignacion_id);
...
alter table titulares drop constraint fk_titulares_propietario_id;
drop index ix_titulares_propietario_id;

alter table titulares drop constraint fk_titulares_asignado_id;
drop index ix_titulares_asignado_id;

alter table titulares drop constraint fk_titulares_asignacion_id;
drop index ix_titulares_asignacion_id;
